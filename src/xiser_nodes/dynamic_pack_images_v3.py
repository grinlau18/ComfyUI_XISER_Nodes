# V3版本的动态打包图像节点 - 支持动态数量的image/mask输入对
import torch
...
class XIS_DynamicPackImagesV3(io.ComfyNode):
    ...
    def define_schema(cls) -> io.Schema:
        ...
        """
        return io.Schema(
            node_id="XIS_DynamicPackImages",
            display_name="Dynamic Pack Images",
            category="XISER_Nodes/Data_Processing",
            description="动态打包图像节点，支持动态数量的image/mask输入对",
            inputs=[
    ...
    @classmethod
    def execute(cls, invert_mask, before_pack_images, **kwargs):
        """
